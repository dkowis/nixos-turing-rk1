...
This flake builds a bootable `nixosSystem` for the [Turing RK1](https://turingpi.com/product/turing-rk1/). It uses u-boot and the stable kernel (6.17) from NixOS 25.05.
